...
(2.2) If MySQL isn't the DBMS you will use, create wrappers for your DBMS in all functions that use "mysqli" in file includes/CoreZfpf.php -- namely functions:
    ...
    update_sql_1s
    delete_sql_1s
NOTE: There is a high probability that Fact Fancy, LLC, can do the above within 30 days, but some coordination and testing would still be required on your part.
