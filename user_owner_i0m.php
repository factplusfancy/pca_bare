...
// to allow calling via a link in administer1.php. Also called by user_owner_io03.php

require 'directory_path_settings.php';
require INCLUDES_DIRECTORY_PATH_ZFPF . '/CoreZfpf.php';
$Zfpf = new CoreZfpf;
$Zfpf->session_check_1c();
if (isset($_SESSION['Scratch']['NewUserNameEmployer'])) // Set in user_owner_io03.php for creating new users.
    $Zfpf->session_cleanup_1c();

if (isset($_POST['LogonRevokedUsersOnly']))
    $_SESSION['Scratch']['PlainText']['LogonRevokedUsersOnly'] = TRUE;

require INCLUDES_DIRECTORY_PATH_ZFPF . '/user_owner_i1m.php';
