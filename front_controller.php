...
//        break;
    case '__DIR__/setup.php':
        include 'setup.php'; // SPECIAL CASE: use include and no break, so if pcm/setup.php, script continues to default case below.
    case '__DIR__/setup_nh3r_practices.php': // TO DO verify correct 
        include 'setup_nh3r_practices.php'; // SPECIAL CASE: use include and no break...
    case '__DIR__/setup_demos_1-3.php': // TO DO verify correct add other setup demos files.
        include 'setup_demos_1-3.php'; // SPECIAL CASE: use include and no break...
    case '__DIR__/setup_demos_4-6.php': // TO DO verify correct 
        include 'setup_demos_4-6.php'; // SPECIAL CASE: use include and no break...
    case '__DIR__/setup_demos_7-9.php': // TO DO verify correct 
        include 'setup_demos_7-9.php'; // SPECIAL CASE: use include and no break...
    case '__DIR__/setup_demos_10-12.php': // TO DO verify correct 
        include 'setup_demos_10-12.php'; // SPECIAL CASE: use include and no break...
    default:
        require 'error.php';
}
*/
