...
Refrigeration systems that contain 10,000 pounds or more of anhydrous ammonia are subject to both OSHA\'s PSM standard (29 CFR 1910.119), the Program 3 Prevention Program requirements of the EPA\'s Chemical Accident Prevention rule, and general-duty law. Combined, these requirements seek to protect employees, contractors, the community, and the environment at or near a facility with a process that contains hazardous substances, such as the '.HAZSUB_PROCESS_NAME_ZFPF.'.
...
IFC -- International Fire Code (IFC). IFC references IIAR standards and includes additional requirements that may apply to the '.HAZSUB_PROCESS_NAME_ZFPF.'. The IFC may be purchased from the International Code Council at http://www.iccsafe.org

NFPA 1 -- National Fire Protection Agency (NFPA) 1. NFPA 1 references IIAR standards and includes additional requirements that may apply to the '.HAZSUB_PROCESS_NAME_ZFPF.'. NFPA 1 may be purchased from the at https://nfpa.org
