...
$AmmoniaRefrigerationAudit = array(
    1 => array(
        ...
        'c6nymd_leader' => $Zfpf->encrypt_1c('Ammonia-refrigeration PSM audit, 2020-07-30 template. Includes GENERAL-DUTY CLAUSE HAZARD-REVIEW content. Provides sample-observation methods that can cover the "minimum system safety requirements" in IIAR 9-2020, which references IIAR 6-2019 and IIAR 7-2019, and the applicable editions of IIAR 2 and building codes, if properly interpreted and applied by the auditor(s), using the terminology of this PSM-CAP App.'), // Put template name and description here. Never overwritten because templates are never issued. (They may be edited)
